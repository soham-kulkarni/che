 ...
 */
@Singleton
public class GitSshAgentLauncher extends AbstractAgentLauncher {
    @Inject
    public GitSshAgentLauncher(@Named("che.agent.dev.max_start_time_ms") long agentMaxStartTimeMs,
    ...
    public String getAgentId() {
        return "org.eclipse.che.git.ssh";
    }
}
